...
<s:form action="rxSearch" method="post">
	...
	<tr><th><label for="rx_id">MarketRx ID:</label></th>
	    <td align="left"><s:textfield name="rxList.id" value="%{id}" size="8" id="rx_id" /></td>
	</tr>
	<tr><th><label for="mb_id">MB ID:</label></th>
	    <td align="left"><s:textfield name="rxList.buck_id" value="%{buck_id}" size="8" id="mb_id" /></td>
	</tr>
	<tr>
	    <th><label for="vouch">Voucher #:</label></th>
	    <td align="left"><s:textfield name="rxList.voucherNum" value="%{voucherNum}" size="10" maxlength="10" id="vouch" /> </td>
	</tr>		  
	<tr>
	...
	<tr>
	    <th><b>Date:</b></th>
	    <td align="left"><label for="from"> From</label><s:textfield name="rxList.date_from" value="%{date_from}" size="10" maxlength="10" cssClass="date" id="from" /><label for="to"> To </label><s:textfield name="rxList.date_to" value="%{date_to}" size="10" maxlength="10" cssClass="date" id="to" /></td>
	</tr>  
	<tr>
