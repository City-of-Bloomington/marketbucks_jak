...
<s:form action="resolutionEdit" method="post">
  ...
  <s:hidden name="resolution.dispute_id" value="%{dispute_id}" />
  ...
  <table border="0" width="90%">
	  ...
	  <tr>
	      ...
	      <td align="left"><s:textfield name="resolution.expire_date" value="%{expire_date}" size="10" cssClass="date" id="exp_date" /></td>
	  </tr>
      </s:if>
      <s:elseif test="reason == 'Not Exist'">
	  <tr>
	  ...
	  <tr>
	      ...
	      <td align="left"><s:textfield name="resolution.new_buck_id" value="%{new_buck_id}" size="8" maxlength="10" id="buck_id" /></td>
	  </tr>
	  <tr>
	  ...
	  <tr>
	      ...
	      <td align="left"><s:select name="resolution.conf_id" value="%conf_id}" list="confs" listKey="id" listValue="info" headerKey="-1" headerValue="" id="conf_id" /></td>
	  </tr>
	  <tr>
