...
<s:form action="giftAdd" method="post" onsubmit="return confirmForCancel()">
  ...
  <table width="90%"><caption> Gift Transaction</caption>
	  ...
	  <td>
		  ...
		  <s:radio name="gift.pay_type" required="true" value="%{pay_type}" list="{'Cash','Check','Money Order','Credit Card','Honorary'}" headerKey="Cash" headerValue="Cash" />
	      </fieldset>
	  </td>
      </tr>	  
      <tr>
	  <th><label for="check_no">Check #/RecTrac:</label></th>
	  <td align="left"><s:textfield name="gift.check_no" maxlength="20" size="20" value="%{check_no}" id="check_no" /></td>
      </tr>
      <s:if test="isCancelled()">
	  <tr>
	      <th><b>Status:</b></th>
  ...
  <s:if test="hasBucks()">
     <table border="1" width="80%"><caption><s:property value="bucksTitle" /></caption>
	  ...
	  <tr>
	      ...
	      <td align="right">$<s:property value="bucksTotal" />.00</td>
	  </tr>
