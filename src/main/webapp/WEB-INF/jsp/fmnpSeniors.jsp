...
<table border="1"><caption><s:property value="#fmnpSeniorsTitle" /></caption>
	<tr>
		<td align="center"><b>ID</b></td>
		<td align="center"><b>FMNP Senior Amount</b></td>
		<td align="center"><b>Ticket #</b></td>
		<td align="center"><b>User</b></td>
		<td align="center"><b>Date & Time</b></td>
		<td align="center"><b>Notes</b></td>
	</tr>
	<s:iterator var="one" value="#fmnpSeniors">
		<tr>
			<td><a href="<s:property value='#application.url' />seniorAdd.action?id=<s:property value='id' />">View/Edit <s:property value="id" /></a></td>
	...
	<s:if test="#showTotal">
		<tr>
			...
			<td align="right">$<s:property value="#seniorTotal" />.00</td>
			<td colspan="4">&nbsp;</td>
		</tr>
	</s:if>
</table>
