...
<s:form action="redeemSearch" method="post">
	...
	<tr><th><label for="rem_id">Redemption ID:</label></th>
	    <td align="left"><s:textfield name="redeemList.id" value="%{id}" size="8" id="rem_id" /></td>
	</tr>
	<tr><th><label for="buck_id">MB/GC ID:</label></th>
	    <td align="left"><s:textfield name="redeemList.buck_id" value="%{buck_id}" size="8" id="buck_id" /></td>
	</tr>
	<tr>
	...
	<tr>
	    ...
	    <td align="left"><s:textfield name="redeemList.vendor_num" value="%{vendor_num}" size="8" id="vendor_num" /></td>
	</tr>  
	<tr>
	...
	<tr>
	    <th><b>Date:</b></th>
	    <td align="left"><label for="from"> From</label><s:textfield name="redeemList.date_from" value="%{date_from}" size="10" maxlength="10" cssClass="date" id="from" /><label for="to"> To </label><s:textfield name="redeemList.date_to" value="%{date_to}" size="10" maxlength="10" cssClass="date" id="to" /></td>
	</tr>  
	<tr>
