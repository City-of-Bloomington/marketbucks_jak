...
<s:form action="user" method="post" id="form_id">
	...
	<tr>
	    ...
	    <td align="left">
		<s:textfield name="person.username" maxlength="30" size="30" value="%{username}" required="true" id="username" /> * (for login)
	    </td>
	</tr>
	<tr>
	...
	<tr>
	    ...
	    <td align="left"><s:checkbox name="person.inactive" value="%{inactive}" id="inactive" /> Yes (check this to inactivate)				
	    </td>
	</tr>
	<tr>
	    <td>&nbsp;</td>
